...
class Post implements IdProviderInterface, CreatedByUserProviderInterface
{
    ...
    #[ORM\JoinTable(name: 'posts_meta')]
    #[ORM\JoinColumn(name: 'post_id', referencedColumnName: 'slug')]
