...
<?= $gridView
    ...
    ->bodyRowAttributes(static fn(array|object $data) => $canUserUpdateUser ? ['class' => 'entity-item-editable', 'data-edit-url' => $urlGenerator->generate('admin/update-user', ['id' => (string)((array)$data)['id']])] : [])
    ->columns(
        new CheckboxColumn(
