...
<div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <?= Html::select('add_nav_item_type')->addAttributes([
            ...
            ->options(
                (new Option)->value(AddNavItemType::Page->value)->content($translator->translate(App::PAGE)),
                (new Option)->value(AddNavItemType::Category->value)->content($translator->translate(App::CATEGORY)),
                (new Option)->value(AddNavItemType::Url->value)->content($translator->translate(App::URL))) ?>
    </div>
...
<div class="mb-3">
    ...
    <?= Html::select('position')->addAttributes([
        ...
        ->options(
            (new Option)->value(NavPosition::Top->value)->content(NavPosition::Top->name),
            (new Option)->value(NavPosition::Left->value)->content(NavPosition::Left->name),
            (new Option)->value(NavPosition::Bottom->value)->content(NavPosition::Bottom->name),
            (new Option)->value(NavPosition::Right->value)->content(NavPosition::Right->name)) ?>
</div>
