...
<?= $gridView
    ...
    ->bodyRowAttributes(static fn(array $data): array => $canUserUpdateNav ? ['class' => 'entity-item-editable', 'data-edit-url' => $urlGenerator->generate('admin/update-nav', ['id' => $data['id']])] : [])
    ->columns(
        new CheckboxColumn(
