        ...
        return $this->viewRenderer
            ->render(
                ...
                [
                    ...
                    'canUserUpdatePage' => $this->roleRepository->userHasPermission($userId, RbacPermission::UPDATE_PAGE),
            ...
            if ($this->formHydrator->populateFromPost($form, $request)) {
                if ($this->formHydrator->validate($form)->isValid() &&
                    ...
                    $entityChangedResult = $post->getSlug()?->getId() !== $form->slug ? $this->postRepository->updateSlug(
                        $post, $this->createSlug($form),
                        $form->description === '',
                        []) :
                        $this->postRepository->save($post, $form->description === '', []);
