        ...
        request.onload = function () {
            ...
            if (request.status === 200) {
                ...
                if (request.status === 403) {
                    ...
                    const errorAlertEl = document.getElementById('delete-entities-error-alert');
                    if (errorAlertEl !== null &&
                        request.responseText.length > 0) {
                        errorAlertEl.innerText = request.responseText;
                        errorAlertEl.classList.remove('d-none');
                    } else {
                        document.getElementById('delete-entities-common-error-alert').classList.remove('d-none');
                    }
                }
            }
        };
